 ...
 * @brief
 * encode_wire_SubmitResv() - encode a Submit Resvervation Batch Request
 *
 ...
 * @par	Data items are:
 * 			string	resv id
 *			list of	attribute, see encode_wire_attropl()
 */
...
int
encode_wire_SubmitResv(int sock, char *resv_id, struct attropl *aoplp)
{
	int   rc;
